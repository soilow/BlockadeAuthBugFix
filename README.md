...
🚀 Во вкладке Response сделайте так, как показано на скриншоте ниже
...
17. Если все равно черный экран, то включите VPN. Игра должна загрузиться. После загрузки можете выключить VPN, чтобы не увеличивать пинг. Вот тут уже все должно работать
